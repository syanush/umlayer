...
class Settings:
    ...
    _ELEMENT_TEXT_NORMAL_COLOR = Qt.black
    _ELEMENT_TEXT_SELECTED_COLOR = _ELEMENT_SELECTED_COLOR

    ELEMENT_TEXT_NORMAL_PEN = QPen(_ELEMENT_TEXT_NORMAL_COLOR)
    ELEMENT_TEXT_SELECTED_PEN = QPen(_ELEMENT_TEXT_SELECTED_COLOR)
